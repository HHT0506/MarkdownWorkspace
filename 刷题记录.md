...
#### [41. 缺失的第一个正数](https://leetcode-cn.com/problems/first-missing-positive/)（原地哈希）



2021.8.6

[41. 缺失的第一个正数](https://leetcode-cn.com/problems/first-missing-positive/)（原地哈希,优化）

#### [148. 排序链表](https://leetcode-cn.com/problems/sort-list/)

#### [103. 二叉树的锯齿形层序遍历](https://leetcode-cn.com/problems/binary-tree-zigzag-level-order-traversal/)（广度优先搜索）

#### [141. 环形链表](https://leetcode-cn.com/problems/linked-list-cycle/)（链表有环）

#### [142. 环形链表 II](https://leetcode-cn.com/problems/linked-list-cycle-ii/)（环的入口点）

#### [102. 二叉树的层序遍历](https://leetcode-cn.com/problems/binary-tree-level-order-traversal/)（广度优先搜索）



2021.8.7

#### [1114. 按序打印](https://leetcode-cn.com/problems/print-in-order/)（多线程）

#### [1115. 交替打印FooBar](https://leetcode-cn.com/problems/print-foobar-alternately/)(多线程)



2021.8.8

5838. 检查字符串是否为数组前缀（力扣周赛）

      [5839. 移除石子使总数最小](https://leetcode-cn.com/problems/remove-stones-to-minimize-the-total/)（力扣周赛）



2021.8.9

#### [113. 路径总和 II](https://leetcode-cn.com/problems/path-sum-ii/)(深度优先搜索)
...
#### [剑指 Offer 47. 礼物的最大价值](https://leetcode-cn.com/problems/li-wu-de-zui-da-jie-zhi-lcof/)（二刷）

#### [53. 最大子序和](https://leetcode-cn.com/problems/maximum-subarray/)（二刷）
...
#### [692. 前K个高频单词](https://leetcode-cn.com/problems/top-k-frequent-words/)（哈希表+数组排序，华为面试题）(优先队列 大根堆)



2021.8.30

#### [39. 组合总和](https://leetcode-cn.com/problems/combination-sum/)（排序+回溯+剪枝）

#### [40. 组合总和 II](https://leetcode-cn.com/problems/combination-sum-ii/)(排序+回溯+剪枝)



2021.9.2

[最高分是多少](https://www.nowcoder.com/questionTerminal/3897c2bcc87943ed98d8e0b9e18c4666?f=discussion)



2021.9.3

#### [121. 买卖股票的最佳时机](https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock/)（二刷）
...
#### [3. 无重复字符的最长子串](https://leetcode-cn.com/problems/longest-substring-without-repeating-characters/)（二刷，动态规划）
